  ...
  const fetchProduct = async () => {
    try {
      const res = await axios.get(`${URLAPI}/product/${id}`);
      ...
      setPreviews({
        image: product.image ? `${URLAPI}/${product.image}` : null,
        SubImageOne: product.SubImageOne ? `${URLAPI}/${product.SubImageOne}` : null,
        SubImageTwo: product.SubImageTwo ? `${URLAPI}/${product.SubImageTwo}` : null,
        SubImageThree: product.SubImageThree ? `${URLAPI}/${product.SubImageThree}` : null,
        SubImageFour: product.SubImageFour ? `${URLAPI}/${product.SubImageFour}` : null,
      });
  ...
  fetchProduct();
    ...
    const updateProduct = async (e) => {
        ...
        await axios.put(`${URLAPI}/product/${id}`, data, {
            headers: {
    ...
    <div className="md:w-3/4 w-full overflow-y-auto p-4">
        ...
        <h2 className="text-3xl font-bold text-center mb-8 text-blue-800"> Update Product</h2>

        <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={updateProduct}>
            {/* Left Section */}
